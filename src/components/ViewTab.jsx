    ...
    async function init() {
      ...
      try {
        ...
        if (userProfile.friendId) {
          ...
          if (!snapFriend.empty) friendUid = snapFriend.docs[0].id
        }
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center gap-4 px-2">
        ...
        <span className="text-[10px] font-bold text-diary-green/20 uppercase tracking-widest font-sans">Story History</span>
        <div className="h-px bg-diary-green/5 flex-1" />
      </div>
